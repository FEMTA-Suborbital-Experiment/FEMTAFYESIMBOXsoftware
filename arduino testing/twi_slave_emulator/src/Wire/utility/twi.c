...
#include "C:\Program Files (x86)\Arduino\hardware\arduino\avr\variants\circuitplay32u4\pins_arduino.h"
#include "twi.h"
...
//  Ethan Kessel mods:
static uint8_t twi_last_slave_rx_addr;
//  End of mods.
...
ISR(TWI_vect)
{
  switch(TW_STATUS){
    ...
    case TW_SR_ARB_LOST_GCALL_ACK: // lost arbitration, returned ack
      ...
      twi_state = TWI_SRX;
      //  Ethan Kessel mods:
      twi_last_slave_rx_addr = TWDR >> 1;  // Store address from data register
      //  End of mods.
    ...
    case TW_SR_STOP: // stop or repeated start condition received
      ...
      twi_onSlaveReceive(twi_rxBuffer, twi_rxBufferIndex, twi_last_slave_rx_addr);
