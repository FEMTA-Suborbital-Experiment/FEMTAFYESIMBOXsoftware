...
#ssh_test("cd 'Project_Files; ls")

def comms_test():
    arg1 = f"ssh {user}@{host} \"cd \\\"Project_Files/Pi testing\\\"; python ssh_leds.py\""
    print(arg1)
    ...
    arg3 = f"ssh {user}@{host} \"cd \\\"Project_Files/Pi testing\\\"; rm state; touch state"
