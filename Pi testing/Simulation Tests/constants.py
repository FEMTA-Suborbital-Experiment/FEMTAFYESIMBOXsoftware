...
N_Air_tank = (P0_tank * VolAir0) / (R * T0_tank) #[mol]         Number of moles of air in both prop tanks
...
N_Air_CC_0 = (P0_CC * V_CC) / (R * T0_CC) #[mol]  Initial number of moles of air in CC
