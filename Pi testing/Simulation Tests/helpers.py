...
@njit(float32(float32), fastmath=toggle_fastmath, cache=True)
def nvcVP(T):
...
# (evaporation)
@njit(float32(float32, float32, float32, float32, float32, float32, float32, float32, float32), fastmath=toggle_fastmath, cache=True)
...
@njit(float32(float32, float32, float32, float32, float32, float32), fastmath=toggle_fastmath, cache=True)
